    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 logo">
                <a href="index.html">
                    <img src="{{  asset('assets/images/logo1.png') }}" class="logo" alt="Logo">
                </a>
            </div>
            ...
            <ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ route('ceo_message') }}">CEO’s Message</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{ route('quality') }}">Quality Policy</a>
                </li>
                <li>
                    <a href="{{ route('certificate') }}">Certificate</a>
                </li>
                <li class="dropdown">
                    <a href="{{ route('services') }}" class="dropdown-toggle" data-toggle="dropdown">Services & Facilities</a>
                    <ul class="dropdown-menu">


                        <li><a href="{{ route('engineering') }}">Engineering</a></li>
                        <li><a href="{{ route('stamping') }}">Stamping</a></li>
                        <li><a href="{{ route('welding') }}">Welding</a></li>
                        <li><a href="{{ route('precision_machine') }}">Precision Maching</a></li>
                        <li><a href="{{ route('quality_assurance') }}">Quality Assurance</a></li>
                    </ul>
                </li>
                <li>
